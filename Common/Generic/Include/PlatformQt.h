...
// from QString
#define PFQT_COPY_QSTR_TO_ASTR(dst, maxLen, src)	PFStringA::Copy(dst, maxLen, (LPCSTR)src.toLocal8Bit().data())
...
#else
#define PFQT_COPY_QSTR_TO_TSTR(dst, maxLen, src)	PFStringA::Copy(dst, maxLen, (LPCSTR)src.toLocal8Bit().data())
#endif
